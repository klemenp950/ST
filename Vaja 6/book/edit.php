...
if ($edit) {
    try {
        BookDB::update($_POST["id"], $_POST["author"], $_POST["title"], $_POST["price"], $_POST["leto"]);
...
<form action="<?= $_SERVER["PHP_SELF"] ?>" method="post">
    ...
    <p><label for="leto">Year:</label>
    <input type="number" name="leto" id="leto" value="<?= $book["leto"] ?>" /></p>
